        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="py-10 bg-blue-50"> {}
                <div className="container max-w-[1370px] mx-auto text-center py-10">
                    ...
                    <p className="text-lg text-gray-600 mb-8">Интернет-магазин дисков. Найдите идеальные диски для
                        вашего автомобиля, выбрав параметры ниже.</p>
            ...
            <section className="py-20 bg-white">
                <div className="container max-w-[1370px] mx-auto text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-8">Мы предлагаем широкий ассортимент дисков для любых
                        автомобилей. Найдите идеальные диски прямо сейчас.</p>

                    {loading ? (
                        <p>Загрузка...</p>
                    ) : noResults ? (
                        <p className="text-gray-500 text-2xl mt-8">Диски по заданным фильтрам не найдены. Попробуйте
