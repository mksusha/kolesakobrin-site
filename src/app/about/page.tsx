                        ...
                        <div className="max-w-[1370px] mx-auto text-center">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-md mx-auto mt-16">
                                ...
                                <div className="text-center max-w-3xl mx-auto px-6 mb-4">
                                    <p className="text-lg text-gray-700 leading-relaxed">
                                        Индивидуальный предприниматель зарегистрирован решением районного
                                        исполнительного комитета № от 10 сентября 2013 года. УНП ,
                                        Брестская обл., Березовский район, г. , ул. , . Сайт
                                        зарегистрирован в Торговом реестре 30 мая 2023 года.
                                    </p>
